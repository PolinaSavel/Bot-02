...
public class TelegramBot extends TelegramLongPollingBot {
    private static final String IDLE_STATE = "IDLE";            //sostoyanie
    ...
    static List<String> INITIAL_KEYBOARD = List.of(    //spisok knopok
            ADD_EXPENSE_BUTTON,
    ...
    void changeState(           //  izmenenie sostoyaniya
            String state,
    ...
    private static ReplyKeyboard buildKeyboard(List<String> btns) {
        if (btns == null || btns.isEmpty()) return new ReplyKeyboardRemove(true);  //udalyaem klaviaturu
        ...
        ReplyKeyboardMarkup markup = new ReplyKeyboardMarkup();  // vidaem klaviaturu polzavatelu
        markup.setKeyboard(rows);
        return markup;
    }

    void handleIdle(Update update, ChatState state) {    //prinimaet vhodyashie soobshenia
    ...
    void handleExpenseEntering(Update update, ChatState state) {
        ...
        changeState(    // izmenenie sostoyaniya
                IDLE_STATE,
                state,
                null,
                chatId,
    ...
    public void onUpdateReceived(Update update) {
        ...
        switch (currentChatState.state) {
            ...
            default -> handleUnknown(update, currentChatState);  //esli ne korrektniy vvod
        }
    }
    ...
    public String getBotToken() {
        return "7272161962:AAG99KRBtZ1JEUHsoWjx4yHWZgmr7J-ODlk";
    }
}
